...
void Game::setTileBagSeeded(int seed) {
...
void Game::addFirstPlayerTile(LinkedList<Tile *> *tileBag){
...
void Game::fillTileBagFromBoxLid(LinkedList<Tile *> *tileBag, int seed) {
    //Fill Tile Bag
    tileBag->addBack(new Tile(FIRST_TILE));
...
void Game::seedTileBag(LinkedList<Tile *> *tileBag, int n){   
    srand(n);  
...
void Game::reset(LinkedList<Tile *> *tileBag) {
   int seed = 5;
